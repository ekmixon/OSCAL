...
# time check
print(f'{bcolors.OKBLUE}Timestamp Check Running{bcolors.ENDC}')
...
try:
    ...
    print(
        f'{bcolors.FAIL}ERROR: Unable to read file or file does not exist: 1) File: {filename1}{bcolors.ENDC}'
    )
...
try:
    ...
    print(
        f'{bcolors.FAIL}ERROR: Unable to read file or file does not exist: 1) File: {filename2}{bcolors.ENDC}'
    )
...
if stat2.st_mtime >= stat1.st_mtime:
    print(
        f'{bcolors.OKGREEN}SUCCESS: Time check passed for: 1) File 1: {filename1}, 2) File 2: {filename2}{bcolors.ENDC}'
    )

else:
    print(
        f'{bcolors.FAIL}ERROR: Time check failed for: 1) File 1: {filename1}, 2) File 2: {filename2}{bcolors.ENDC}'
    )
